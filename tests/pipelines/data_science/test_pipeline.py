...
from open_finance_lakehouse.pipelines.data_science import create_pipeline as create_ds_pipeline
from open_finance_lakehouse.pipelines.data_science.nodes import split_data
