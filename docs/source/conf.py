...
# open_finance_lakehouse documentation build
...
from open_finance_lakehouse import __version__ as release

# -- Project information -----------------------------------------------------

project = "open_finance_lakehouse"
author = "Kedro"
...
htmlhelp_basename = "open_finance_lakehousedoc"
...
latex_documents = [
    (
        master_doc,
        "open_finance_lakehouse.tex",
        "open_finance_lakehouse Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "open_finance_lakehouse",
        "Project open_finance_lakehouse codebase.",
        "Data-Science",
    )
]
